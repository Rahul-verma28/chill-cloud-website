  ...
  const products = [
    {
      ...
      description:
        "Original, Paan Kiwi Mint, American Freezer, Dubai Class, Spring Water, Commissioner, Double Apple, Kesar Saffron.",
    },
    {
      icon: <PackageCheck className="w-5 h-5" />,
      title: "Pre-Rolled Cones",
      description:
        "Ultra-thin French paper cones for a slow, natural burn. Available in King Size – Brown & White, ready to use with protective straws.",
    },
    {
      icon: <Leaf className="w-5 h-5" />,
      title: "Premium Rolling Papers",
      description:
        "Crafted from organic, high-quality materials for a clean, even burn. Available in Twin Pack, Trio Pack, Four Pack, Booklet, and Pro Pack formats in White and Brown.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="max-w-3xl mx-auto text-gray-400 text-lg md:text-xl font-light leading-relaxed">
              India&apos;s leading manufacturer, wholesaler, and trader of
              premium smoking products — where traditional precision meets
              modern luxury.
            </p>
          </motion.div>
        </div>
            ...
            <motion.div {...fadeUp} className="space-y-8">
              ...
              <div className="space-y-6 text-gray-400 font-light text-base md:text-lg leading-relaxed">
                <p>
                  ...
                  is India&apos;s leading manufacturer, wholesaler, and trader
                  of premium smoking products, including hand-rolled Ciga-Rolls,
                  Slims, pre-rolled cones, and premium rolling papers. As
                  innovators in the industry, Chillcloud has become synonymous
                  with quality, craftsmanship, and an elevated smoking
                  experience.
                </p>
                <p>
                  Our state-of-the-art manufacturing facility and skilled
                  workforce ensure every product meets the highest standards.
                  From the ultra-thin pre-rolled cones to our flavorful
                  hand-rolled Ciga-Rolls, every item undergoes rigorous quality
                  checks to guarantee consistent performance, aesthetic appeal,
                  and unmatched taste.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-white/10">
                <p
                  ...
                  style={{ fontFamily: "var(--font-playfair)" }}
                >
                  &ldquo;Chillcloud makes it chill, so you can enjoy life to the
                  fullest.&rdquo;
                </p>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeUp}>
              ...
              <div className="relative">
                ...
                <p className="text-gray-400 text-lg md:text-xl font-light leading-relaxed max-w-3xl mx-auto">
                  At Chillcloud, our mission is to bring ease, comfort, and
                  exceptional quality to every smoking experience. We simplify
                  the process so you can focus on the moment —{" "}
                  <span className="text-white font-medium">
                    we make it chill, so you can enjoy life to the fullest.
                  </span>
                </p>
              </div>
            </motion.div>
