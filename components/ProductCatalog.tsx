...
export default function ProductCatalog({
  ...
  > = {
    All: {
      ...
      description:
        "Explore the full range of our hand-crafted luxury products — from Cigrolls and Cones to Rolling Papers and Slims.",
    },
    Cigrolls: {
      ...
      description:
        "Every cigroll is designed for balance, smoothness, and a satisfying finish — elevating every moment with effortless cool.",
    },
    Cones: {
      ...
      highlight: "Cones",
      description:
        "Precision-crafted pre-rolled cones in Brown, White, and Flavored Jar variants. Ready for the perfect session.",
    },
    "Rolling Paper": {
      ...
      highlight: "Papers",
      description:
        "Crafted with precision and care, every sheet enhances your smoking experience with elegance and consistency.",
    },
    Slims: {
      ...
      highlight: "Slims",
      description:
        "Each Slim is designed for perfect balance, smoothness, and a satisfying finish — elevating every moment with effortless cool.",
    },
  };
  ...
  return (
    <section
      className="py-24 bg-gradient-to-t from-[#12100E] via-[#0D0D0D] to-[black]"
      id="catalog"
    >
        ...
        {filteredProducts.length === 0 && (
          <div className="py-32 text-center">
            <p className="text-white/70 italic">
              No pieces found in this exclusive collection.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="relative bg-[#1A1612] rounded-[1.5rem] overflow-hidden border border-white/5 h-full flex flex-col transition-all duration-500 group-hover:border-[#D4AF37]/30 group-hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)]">
          ...
          <div className="p-3 sm:p-4 flex flex-col flex-grow">
            <div className="mb-3">
              ...
              <h3
                className="text-xl font-bold text-white mb-2 group-hover:text-[#D4AF37] transition-colors duration-300"
                style={{ fontFamily: "var(--font-playfair)" }}
              >
                {product.name}
              </h3>
            ...
            {product?.packSize && (
              <div className="mt-auto pt-2 sm:pt-4 border-t border-white/5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[8px] text-[#D4AF37] font-bold tracking-tighter uppercase">
                    Available
                  </span>
                </div>
              </div>
