        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
          ...
          <div className="mb-8 md:mb-6">
            <div className="relative group">
              ...
              <div className="relative px-4 py-2 border border-[#d4af37] rounded-full">
          ...
          {/* Main Headline */}
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-center mb-6 md:mb-8 max-w-5xl leading-tight">
            <span className="text-white">Our New Experience is</span>
            <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#d4af37] via-[#f4d03f] to-[#d4af37] italic ">
              Rolling Out
            </span>
          ...
          {/* Description */}
          <p className="text-base md:text-lg text-gray-400 max-w-2xl text-center mb-10 md:mb-12 leading-relaxed px-4">
            We are currently crafting a premium digital experience to match our world-class{' '}
            <span className="text-[#d4af37] font-semibold">Ciga-Rolls and Cones</span>. Stay tuned for the ultimate chill.
          </p>
          ...
          <div className="max-w-7xl mx-auto px-6 py-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                <a href="#" className="w-10 h-10 rounded-full bg-[#1a1a1a] border border-[#333] flex items-center justify-center hover:border-[#d4af37] hover:bg-[#d4af37]/10 transition-all duration-300 group">
                  <svg className="w-5 h-5 text-gray-400 group-hover:text-[#d4af37]" fill="currentColor" viewBox="0 0 24 24">
